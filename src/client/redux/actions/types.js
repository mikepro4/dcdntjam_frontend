...
export const FETCH_USER_START = "app/FETCH_USER_START";
export const FETCH_USER = "app/FETCH_USER";
export const CLEAR_EXTERNAL_USER = "app/CLEAR_EXTERNAL_USER";
...
export const HIDE_BOTTOM_SLIDER = "app/HIDE_BOTTOM_SLIDER";
...
export const PROFILE_LOAD_MY_VIDEOS = "app/PROFILE_LOAD_MY_VIDEOS";
export const PROFILE_LOAD_MY_VIDEOS_SUCCESS = "app/PROFILE_LOAD_MY_VIDEOS_SUCCESS";
export const PROFILE_CLEAR_MY_LOADED_VIDEOS = "app/PROFILE_CLEAR_MY_LOADED_VIDEOS";

export const PROFILE_LOAD_MY_HARDWARE = "app/PROFILE_LOAD_MY_HARDWARE";
export const PROFILE_LOAD_MY_HARDWARE_SUCCESS = "app/PROFILE_LOAD_MY_HARDWARE_SUCCESS";
export const PROFILE_CLEAR_MY_HARDWARE = "app/PROFILE_CLEAR_MY_HARDWARE";
...
export const PAGE_SEARCH_COLLECTION_VIDEO_APPEND = "app/PAGE_SEARCH_COLLECTION_VIDEO_APPEND";
...
export const PAGE_TRENDING_SCROLL_UPDATE = "app/PAGE_TRENDING_SCROLL_UPDATE";
export const PAGE_TRENDING_COLLECTION_CLEAR = "app/PAGE_TRENDING_COLLECTION_CLEAR";

export const PAGE_TRENDING_COLLECTION_UPDATE = "app/PAGE_TRENDING_COLLECTION_UPDATE";
export const PAGE_TRENDING_COLLECTION_APPEND = "app/PAGE_TRENDING_COLLECTION_APPEND";

// =============================================================================

// Page Search

export const PAGE_PROFILE_TAB_UPDATE = "app/PAGE_PROFILE_TAB_UPDATE";
export const PAGE_PROFILE_SCROLL_UPDATE = "app/PAGE_PROFILE_SCROLL_UPDATE";
export const PAGE_PROFILE_COLLECTION_CLEAR = "app/PAGE_PROFILE_COLLECTION_CLEAR";

export const PAGE_PROFILE_COLLECTION_VIDEO_UPDATE = "app/PAGE_PROFILE_COLLECTION_VIDEO_UPDATE";
export const PAGE_PROFILE_COLLECTION_VIDEO_APPEND = "app/PAGE_PROFILE_COLLECTION_VIDEO_APPEND";

export const PAGE_PROFILE_COLLECTION_REPOSTS_UPDATE = "app/PAGE_PROFILE_COLLECTION_REPOSTS_UPDATE";
export const PAGE_PROFILE_COLLECTION_REPOSTS_APPEND = "app/PAGE_PROFILE_COLLECTION_REPOSTS_APPEND";
